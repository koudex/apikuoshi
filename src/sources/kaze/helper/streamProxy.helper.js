...
// NOTE: MegaPlay's decrypted m3u8s point at rotating CDN hosts —
// fetch.nexabloom.top / *.qeltrix.top / *.zhaevor.top (fallback list in
// the player's check_domain.json) — and the player's own proxy map uses
// *.akirax.buzz. The subtitle CDNs 403 without the megaplay Referer, so
// proxied fetches must always send streamRefererHeaders().
